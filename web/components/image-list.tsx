    ...
    <div className="space-y-1">
      {images.map((image) => {
        ...
        return (
          <div
            key={image.id}
            className="flex items-center justify-between p-3 rounded-lg hover:bg-muted/50 group transition-all"
          >
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="grid gap-6 py-4">
            ...
            <div className="aspect-square rounded-lg overflow-hidden bg-muted border relative group">
              ...
              {signedUrl ? (
                <Image src={signedUrl} alt="Preview" fill className="object-contain" unoptimized />
              ) : (
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <Button size="sm" onClick={handleTransform} disabled={isSigning} className="gap-2">
