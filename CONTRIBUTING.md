...
This project uses a monorepo structure with an **Express** backend (Node.js) and a **Next.js** frontend dashboard, managed by **pnpm** and **Turborepo**.
...
- Run `pnpm build` at the root before submitting a PR to verify that all packages build correctly.
